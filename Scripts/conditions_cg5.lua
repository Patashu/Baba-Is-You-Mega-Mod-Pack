	...
	if (conds ~= nil) then
		if (#conds > 0) then
			...
			for i,cond in ipairs(conds) do
				...
				elseif activemod.customConditions[basecondtype] ~= nil then
					valid = true
					if isnot == "not" then
						result = result and not activemod.customConditions[basecondtype](params, unitid, x, y)
					else
						result = result and activemod.customConditions[basecondtype](params, unitid, x, y)
					end
				end
			end
